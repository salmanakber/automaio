...
export const WEBFLOW_CMS_SETUP_GUIDE = [
  ...
  { field: 'Config Type', slug: 'config-type', type: 'Plain text', required: false },
  { field: 'Template ID', slug: 'template-id', type: 'Plain text', required: false },
  { field: 'Template Config', slug: 'template-config', type: 'Plain text', required: false },
  { field: 'Iframe URL', slug: 'iframe-url', type: 'Plain text', required: false },
  { field: 'Iframe Height', slug: 'iframe-height', type: 'Plain text', required: false },
  { field: 'Iframe Sandbox', slug: 'iframe-sandbox', type: 'Plain text', required: false },
