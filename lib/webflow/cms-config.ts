...
export const WEBFLOW_CMS_SETUP_GUIDE = [
  ...
  { field: 'HTML Content', slug: 'html-content', type: 'Plain text (long)', required: true },
  { field: 'CSS Content', slug: 'css-content', type: 'Plain text (long)', required: true },
  { field: 'JS Content', slug: 'js-content', type: 'Plain text (long)', required: false },
