...
export const DEFAULT_CMS_FIELD_MAPPING = {
  ...
  'automaio-template-id': 'automaio-template-id',
  'seo-title': 'seo-title',
...
export const WEBFLOW_CMS_SETUP_GUIDE = [
  { field: 'Name', slug: 'name', type: 'Plain text', required: true },
  ...
  { field: 'Template HTML', slug: 'template-html', type: 'Plain text (long)', required: true },
