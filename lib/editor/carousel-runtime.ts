...
[data-am-carousel-nav]{position:absolute;inset:0;pointer-events:none;display:flex;align-items:center;justify-content:space-between;padding:0 12px}
[data-am-carousel-prev],[data-am-carousel-next]{pointer-events:auto;width:42px;height:42px;border-radius:999px;border:0;background:rgba(255,255,255,0.95);color:#0f172a;cursor:pointer;box-shadow:0 4px 20px rgba(15,23,42,0.22);display:flex;align-items:center;justify-content:center;transition:transform .15s ease,background .15s ease}
[data-am-carousel-prev]:hover,[data-am-carousel-next]:hover{transform:scale(1.08);background:#fff}
[data-am-carousel-prev] svg,[data-am-carousel-next] svg{width:20px;height:20px;stroke:currentColor;fill:none;stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}
